...
catCascade = cv2.CascadeClassifier('trainings/cascade.xml')
facecount = 0
catcount = 0
...
while True:
	...
	cats = catCascade.detectMultiScale(frame)
	...
	cv2.putText(frame, 'Cats: '+str(catcount), (50,40), cv2.FONT_HERSHEY_SIMPLEX, 2, (255, 0 ,0))
